	...
	deleteStyles: function() {
        webSqlStorage.getDatabase(function(db) {
            ...
            db.transaction(function (tx) {
                tx.executeSql('DELETE * [styles]');
                tx.executeSql('DELETE * [sqlite_sequence]');
                tx.executeSql('DELETE * [sections]');
                tx.executeSql('DELETE * [section_meta]');
            });
        });
	},

...
源地址：${downloadUrl}`);
      ...
      downloadTip.innerHTML = renameEnabled ? `已在后台启动下载，请勿刷新页面<br/>${downloadInfo}` : `已在新窗口启动下载<br/>${downloadInfo}`;
